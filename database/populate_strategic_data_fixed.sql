...
BEGIN
    ...
    ('P2-C1', 'Child Protection', 
     ...
     pillar_lives_id,
     '["Child protection awareness sessions", "Psychosocial wellbeing activities (TEAMUP, Journey of Life)", "Training community structures and service providers", "Child protection case management", "Family tracing and reunification", "Alternative care for separated children"]'::jsonb,
     1, true),
     
    ('P2-C2', 'Gender-Based Violence Prevention and Response', 
     'Prevention and response to all forms of gender-based violence',
     pillar_lives_id,
     '["GBV awareness and prevention campaigns", "Survivor-centered case management", "Safe spaces and support services", "Engaging men and boys in prevention", "Community-based GBV response mechanisms"]'::jsonb,
     2, true),
     
    ('P2-C3', 'Women Protection and Empowerment', 
     'Protection and empowerment services for women and adolescent girls',
     pillar_lives_id,
     '["Women protection awareness sessions", "Safe spaces for women and girls", "Economic empowerment linked to protection", "Leadership and decision-making support", "Reproductive health rights education"]'::jsonb,
     3, true),
     
    ('P2-C4', 'Youth Protection and Positive Development', 
     'Protection services and positive development opportunities for youth',
     pillar_lives_id,
     '["Youth protection awareness sessions", "Youth-friendly safe spaces", "Life skills and positive development programs", "Youth leadership and civic engagement", "Prevention of harmful practices"]'::jsonb,
     4, true);
    ...
    ('P3-C1', 'Livelihood Support and Economic Strengthening', 
     ...
     '["Cash and voucher assistance", "Income generating activities support", "Financial literacy training", "Savings and lending groups (VSLA)", "Market linkages and value chain development"]'::jsonb,
     1, true),
     
    ('P3-C2', 'Food Security and Nutrition', 
     'Ensuring food security and improved nutrition for vulnerable populations',
     pillar_livelihoods_id,
     '["Food assistance programs", "Nutrition education and counseling", "Kitchen gardening and small-scale farming", "Infant and young child feeding support", "Emergency food response"]'::jsonb,
     2, true);
    ...
    ('P4-C1', 'Mental Health Services', 
     ...
     '["Mental health assessment and counseling", "Referral to specialized services", "Community mental health awareness", "Psychotropic medication support where needed", "Mental health first aid training"]'::jsonb,
     1, true),
     
    ('P4-C2', 'Psychosocial Support Programs', 
     'Group and community-based psychosocial support activities',
     pillar_mental_health_id,
     '["Psychosocial support groups", "Art and play therapy", "Sport and recreation activities", "Community healing and reconciliation", "Peer support programs"]'::jsonb,
     2, true);
    ...
    ('E1-C1', 'Education and Literacy', 
     ...
     pillar_knowledge_id,
     '["Accelerated education programs", "Adult literacy classes", "Early childhood education", "Secondary education support", "Girls education programming"]'::jsonb,
     1, true),
     
    ('E1-C2', 'Skills Training and Vocational Education', 
     'Technical and vocational skills training for employment',
     pillar_knowledge_id,
     '["Vocational skills training", "Apprenticeship programs", "Entrepreneurship training", "Digital literacy and ICT skills", "Life skills education"]'::jsonb,
     2, true),
     
    ('E1-C3', 'Leadership and Civic Engagement', 
     'Building leadership capacity and promoting civic participation',
     pillar_knowledge_id,
     '["Leadership training for women and youth", "Civic education programs", "Community governance support", "Youth councils and platforms", "Advocacy and campaigning skills"]'::jsonb,
     3, true);
    ...
    ('E2-C1', 'Access to Productive Resources', 
     ...
     pillar_resources_id,
     '["Agricultural inputs and tools", "Micro-credit and loans", "Asset transfers", "Land rights support", "Technology and equipment access"]'::jsonb,
     1, true),
     
    ('E2-C2', 'Access to Basic Services', 
     'Improving access to essential health, education, and social services',
     pillar_resources_id,
     '["Health service linkages", "Education fee support", "WASH facilities and services", "Legal aid and documentation", "Social protection linkages"]'::jsonb,
     2, true),
     
    ('E2-C3', 'Access to Information', 
     'Ensuring access to relevant information and knowledge',
     pillar_resources_id,
     '["Information and communication platforms", "Market information systems", "Rights and services information", "Digital information access", "Community knowledge sharing"]'::jsonb,
     3, true);
    ...
    ('E3-C1', 'Business and Employment Opportunities', 
     ...
     '["Job placement and matching", "Business incubation support", "Market linkages and networking", "Contract farming arrangements", "Private sector partnerships"]'::jsonb,
     1, true),
     
    ('E3-C2', 'Youth Development Opportunities', 
     'Comprehensive youth development and transition support',
     pillar_opportunities_id,
     '["Youth internships and work experience", "Mentorship programs", "Innovation and creativity hubs", "Sports and arts opportunities", "Youth exchange programs"]'::jsonb,
     2, true),
     
    ('E3-C3', 'Women Economic Empowerment', 
     'Economic empowerment opportunities specifically for women',
     pillar_opportunities_id,
     '["Women business networks", "Cooperative and collective enterprises", "Value addition and processing", "Cross-border trade support", "Women leadership in business"]'::jsonb,
     3, true);
